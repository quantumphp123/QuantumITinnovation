...
if ( function_exists( 'smile_update_settings' ) ) {
	...
	smile_update_options(
		'Smile_Info_Bars', 'blank', array_merge(
			$name,
			$ib_content,
			$background,
			$close_link,
	...
	// Style - newsletter.
	smile_update_options(
		'Smile_Info_Bars', 'newsletter', array_merge(
			$name,
			$background,
			$cp_form,
			$close_link,
	...
	smile_update_options(
		'Smile_Info_Bars', 'image_preview', array_merge(
			$name,
			$background,
			$ifb_img,
			$cp_form,
	...
	// Style - get_this_deal.
	smile_update_options(
		'Smile_Info_Bars', 'get_this_deal', array_merge(
			$name,
			$background,
			$cp_form,
			$close_link,
	...
	// Style - free_trial.
	smile_update_options(
		'Smile_Info_Bars', 'free_trial', array_merge(
			$name,
			$background,
			$ifb_img,
			$cp_form,
	...
	// Style - free_trial.
	smile_update_options(
		'Smile_Info_Bars', 'countdown', array_merge(
			$name,
			$background,
			$cp_count_down,
			$close_link,
	...
	smile_update_options(
		'Smile_Info_Bars', 'weekly_article', array_merge(
			$name,
			$background,
			$ifb_img,
			$cp_form,
	...
	smile_update_options(
		'Smile_Info_Bars', 'social_info_bar', array_merge(
			$name,
			$ib_content,
			$background,
			$cp_social,
