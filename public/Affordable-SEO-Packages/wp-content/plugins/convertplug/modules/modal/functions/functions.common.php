...
if ( function_exists( 'smile_update_settings' ) ) {
	...
	smile_update_options(
		'Smile_Modals', 'social_inline_share',
		array_merge(
			$name,
			$secondary_title,
			$background,
	...
	// Social Widget Box.
	smile_update_options(
		'Smile_Modals', 'social_widget_box',
		array_merge(
			$name,
			$secondary_title,
			$background,
	...
	smile_update_options(
		'Smile_Modals', 'social_media_with_form',
		array_merge(
			$name,
			$background,
			$cp_form,
...
if ( function_exists( 'smile_remove_option' ) ) {
	...
	// First Order.
	smile_remove_option(
		'Smile_Modals', 'first_order', array(
			'input_bg_color',
			'placeholder_color',
			'placeholder_text',
			'name_text',
	...
	// Locked Content.
	smile_remove_option(
		'Smile_Modals', 'locked_content', array(
			'image_position',
		)
	);
	...
	// First Order 2.
	smile_remove_option(
		'Smile_Modals', 'first_order_2', array(
			'input_bg_color',
			'placeholder_color',
			'placeholder_text',
			'name_text',
	...
	// Direct Download.
	smile_remove_option(
		'Smile_Modals', 'direct_download', array(
			'input_bg_color',
			'placeholder_color',
			'placeholder_text',
			'name_text',
