...
if ( function_exists( 'smile_update_settings' ) ) {
	...
	smile_update_options(
		'Smile_Slide_Ins', 'floating_social_bar',
		array_merge(
			$name,
			$cp_social,
			$adv_design_options,
	...
	// social_widget_box.
	smile_update_options(
		'Smile_Slide_Ins', 'social_widget_box',
		array_merge(
			$name,
			$background,
			$widget_close,
