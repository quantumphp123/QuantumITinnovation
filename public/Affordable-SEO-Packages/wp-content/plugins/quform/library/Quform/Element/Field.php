...
abstract class Quform_Element_Field extends Quform_Element
{
     ...
     *
     * @deprecated 2.1.1 Use addError
     * @param string $message
     */
    public function setError($message)
    {
        _deprecated_function(__METHOD__, '2.1.1', 'addError');
    ...
    /**
     * @deprecated 2.1.1 Use clearErrors
     */
    public function clearError()
    {
        _deprecated_function(__METHOD__, '2.1.1', 'clearErrors');
