...
@section('meta')
    ...
    <title>Mobile App & Web Development, Digital Marketing Agency USA, UK & India</title>
    <meta name="description" content="Quantum IT Innovation is the leading Mobile App & Web Development and Digital Marketing agency. It delivers next-gen Digital Solutions to enable the business to increase the ROI across the globe especially the USA, UK & India. We have worked with all sizes of business from Startup, SMEs to the industry.">
                            ...
                            <div class="col-lg-4 col-md-6 wow move-up" style="padding:1%;">
                                ...
                                <div class="ht-box-images style-05">
                                    <div class="image-box-wrap" style="border-radius: 13px 13px 0px 0px;">
                                        <div class="box-image digital_sbox">
                                            <!--  -->
                                        </div>
                                        <div class="content sbox_content">
                                            <h5 class="heading">Digital<br>Marketing </h5>
                                            <div class="divider_san"></div>
                                            <div class="text" style="padding-top: 2%;">{{substr("We offer innovative Digital Marketing services. We based out of India, USA, and UK. We are catering to our clients based out of UK, USA, Singapore, Canada, Australia, UAE and other parts of the World",0,115)}}<strong>...</strong>
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-wrap text-center section-space--mb_40">
                        <h3 class="heading">Our <span class="text-color-primary">App</span>, <span class="text-color-primary">Web</span> & <span class="text-color-primary">Digital Marketing</span><br>Services and Offerings</h3>
