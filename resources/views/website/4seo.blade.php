      ...
      <div class="container">
        <div class="row">
            <div class="col-md-12 mt-3 text-center">
                    <h2 class="top-head">4 SEO ideas that can make your rankings reach sky-high.</h2>
                    </div><!--12-->
