...
@section('meta')
    ...
    <title>Android App Development Company USA, UK | App Development Services USA</title>
    <meta name="keywords" content="Android App Development Company USA, App Development Company UK, Android App Development Company UK">
	<meta name="description" content="Quantumitinnovation is one of the leading Android App Development Company USA serving abroad with 500+ apps built, offering Android Native & Hybrid Application Development located in India, USA & UK. We have a highly experienced and dedicated Android App development Team. Get your app at an affordable price.">
...
<div class="site-wrapper-reveal">
    ...
    <div class="title_image" role="listbox" style="background-image:url({{asset('assets/img/service-images/a1.jpg')}});">
        
        <div class="carousel-caption text-left">
            <div class="animated fadeInDown">
                <h1 class="title_h1 h1_banner">Launch Your <br> Android App With Us!</h1>
                <div id="line"></div>
                 <div class="row">
                    <div class="col-lg-7 col-md-7">
                        <p class="text-white title_p">
                            <span>We deliver mobile app experiences that get your mobile app trending on the apps stores.</span>
                        </p>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-5 col-md-5">
                <div class="top_sec">
                    ...
                    <p class="mt-3 txt-algn">Quantum offers android mobile app development, which has plenty of features such as providing excellent security to your personal and business data, comes with stunning and adaptive designs for all mobile screen sizes, optimized memory, compatibility to all mobile devices and reliability. 
                    </p>
                   
                </div>    
            </div>
            <div class="col-lg-7 col-md-7 plr-30">
                <div class="rgt_sec">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <img src="{{asset('assets/img/icons/mobile-app-strategy.png')}}">
                            <h6 class="ser-sec">MOBILE APP STRATEGY</h6>
                            <p class="txt-algn">Quantum is a top mobile app development company that helps in defining and implementing a successful strategy for the success of your business.</p>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <img src="{{asset('assets/img/icons/mobile-app-designs.png')}}">
                            <h6 class="ser-sec">MOBILE APP DESIGNS</h6>
                            <p class="txt-algn">Design and user experience can make or break your mobile app. Our mobile app development company provides services that ensures excellent designs and user interface.</p>
                        </div>
                         <div class="col-lg-6 col-md-6 mt-5">
                            <img src="{{asset('assets/img/icons/mobile-app-development.png')}}">
                            <h6 class="ser-sec">MOBILE APP DEVELOPMENT</h6>
                            <p class="txt-algn">Quantum, a leading mobile app development company has a strong team of developers with an average industry experience of 5+ years.</p>
                        </div>
                        <div class="col-lg-6 col-md-6 mt-5">
                            <img src="{{asset('assets/img/icons/mobile-app-testing.png')}}">
                            <h6 class="ser-sec">MOBILE APP TESTING</h6>
                            <p class="txt-algn">Our offshore mobile application development experts provides you high performance and 100% reliable mobile app testing services.</p>
                        </div>
                         <div class="col-lg-6 col-md-6 mt-5">
                            <img src="{{asset('assets/img/icons/enterprise-mobile-apps.png')}}">
                            <h6 class="ser-sec">ENTERPRISE MOBILE APPS</h6>
                            <p class="txt-algn">Our mobile app development company in India has experts, developers and analysts working on enterprise mobile application development for fortune 1000 customers.</p>
                        </div>
                        <div class="col-lg-6 col-md-6 mt-5">
                            <img src="{{asset('assets/img/icons/mobile-game-develpoment.png')}}">
                            <h6 class="ser-sec">MOBILE GAME DEVELOPMENT</h6>
                            <p class="txt-algn">Quantum is a top offshore mobile app development company in India that provides robust, high performance and reliable mobile game development services.</p>
                        </div>
                    </div>
                </div>    
            </div>        
        </div>
        <h5 class="text-center mb-5">OUR INTEGRATIONS POWER YOUR APPS, <br> ROCKETING THEM TO THE NEXT LEVEL</h5>
        ...
        <div class="container meth-section mt-2">
            <h5 class="text-center mb-5">Our App Development Methodology</h5>
            <div class="row">
        ...
        <div class="container mt-5">
            <div class="content mb-5">
                <h5 class="text-center mb-5">Our Android App Development Company Approaches</h5>
                ...
                <p>Hybrid apps, such as web apps, you install it like a Native app. Hybrid apps are built with standard web technologies like JavaScript, HTML5, and CSS. 
                ...
                <p>Both of the above mentioned Native and Hybrid app development approaches have their own pros and cons. 
        ...
        <h5 class="text-center mb-5">Technology Stack<div class="u-l"></div></h5>
          <ul class="nav nav-tabs ml-3" role="tablist">
            <li class="nav-item bdr-r">
              <a class="nav-link active" data-toggle="tab" href="#home"><img src="{{asset('assets/img/icons/at1.png')}}"><p class="txt-white">Programming Language</p></a>
            </li>
            <li class="nav-item bdr-r">
              <a class="nav-link" data-toggle="tab" href="#menu1"><img src="{{asset('assets/img/icons/at2.png')}}"><p class="txt-white">IDE</p></a>
            </li>
            <li class="nav-item bdr-r">
              <a class="nav-link" data-toggle="tab" href="#menu2"><img src="{{asset('assets/img/icons/at3.png')}}"><p class="txt-white">Database</p></a>
            </li>
            <li class="nav-item bdr-r">
              <a class="nav-link" data-toggle="tab" href="#menu3"><img src="{{asset('assets/img/icons/at4.png')}}"><p class="txt-white">Tools</p></a>
            </li>
            <li class="nav-item m-bdr">
              <a class="nav-link ml-5" data-toggle="tab" href="#menu4"><img src="{{asset('assets/img/icons/at5.png')}}"><p class="txt-white">Frameworks</p></a>
            </li>
          </ul>
          <div class="tab-content">
            <div id="home" class="container tab-pane active"><br>
              <img src="{{asset('assets/img/icons/kotlin.png')}}" class="ml-5 mr-5 mmb-1">
              <img src="{{asset('assets/img/icons/Java_logo_icon.png')}}" class="ml-5 mr-5 mmb-1">
              <img src="{{asset('assets/img/icons/xml.png')}}" class="ml-5 mr-5">
            </div>
            <div id="menu1" class="container tab-pane fade"><br>
              <img src="{{asset('assets/img/icons/android-studio.png')}}" class="ml-5 mr-5">
            </div>
            <div id="menu2" class="container tab-pane fade"><br>
              <img src="{{asset('assets/img/icons/realm.png')}}" class="ml-5 mr-5 mmb-1">
              <img src="{{asset('assets/img/icons/sqlite.png')}}" class="ml-5 mr-5 mmb-1">
            </div>
             <div id="menu3" class="container tab-pane fade"><br>
               <img src="{{asset('assets/img/icons/NDK.png')}}" class="ml-5 mr-5 mmb-1">
               <img src="{{asset('assets/img/icons/SDK.png')}}" class="ml-5 mr-5 mmb-1">
            </div>
            <div id="menu4" class="container tab-pane fade"><br>
              <img src="{{asset('assets/img/icons/retrofit.png')}}" class="ml-5 mr-5 mmb-1">
              <img src="{{asset('assets/img/icons/glide_logo.png')}}" class="ml-5 mr-5 mmb-1">
              <img src="{{asset('assets/img/icons/picasso.png')}}" class="ml-5 mr-5 mmb-1">
              <img src="{{asset('assets/img/icons/dagger.png')}}" class="ml-5 mr-5 mmb-1">
    ...
    <div class="why-choose-us mt-5" style="background-image:url(assets/img/Group-new.png);">
        <div class="container pb-5">
            <h5 class="text-center clr-wht pt-5">Why Choose Quantum for Android App Development Services?</h5>
            <div class="row">
                <div class="col-lg-6 col-md-6 mt-5">
                    <div id="accordion">
                        <div class="card cust-card ">
                          <!--<div class="card-header">-->
                           ...
                           <i class="fa fa-plus" aria-hidden="true"></i> Customer-Centric Process
                            </a>
                          <!--</div>-->
                        ...
                        <div class="card cust-card ">
                          <!--<div class="card-header">-->
                           ...
                           <i class="fa fa-plus" aria-hidden="true"></i> Third Party SDK Integrations
                          </a>
                          <!--</div>-->
                        ...
                        <div class="card cust-card ">
                          <!--<div class="card-header">-->
                            <a class="collapsed card-link" data-toggle="collapse" href="#collapseThree">
                             <i class="fa fa-plus" aria-hidden="true"></i> Comprehensive App Testing & Support
                            </a>
                          <!--</div>-->
                ...
                <div class="col-lg-6 col-md-6 mt-5 mmt-0">
                    <div id="accordion">
                        <div class="card cust-card ">
                          <!--<div class="card-header">-->
                            <a class="card-link" data-toggle="collapse" href="#collapseSeven">
                            <i class="fa fa-plus" aria-hidden="true"></i> Strict Adherence to Development Guidelines 
                            </a>
                          <!--</div>-->
                        ...
                        <div class="card cust-card">
                          <!--<div class="card-header">-->
                           ...
                           <i class="fa fa-plus" aria-hidden="true"></i>Cost Effective Service 
                          </a>
                          <!--</div>-->
