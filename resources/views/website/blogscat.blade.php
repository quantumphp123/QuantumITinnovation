   ...
   <div class="container">
      <div class="row">
         ...
         <div class="category-section" style="text-align: center; margin-top: 3%;">
            ...
            <a href="{{url('/category/'.$category->id)}}" class="cat-anchor" style="text-transform:uppercase;">{{$category->name}}</a>
            @endforeach
         </div>
                    ...
                    <div class="col-lg-4 col-md-6  mb-30 wow move-up">
                        ...
                        <div class="single-blog-item blog-grid">
                            ...
                            <div class="post-info lg-blog-post-info">
                                ...
                                <div class="btn-text">
                                    <a href="{{url("$blog->url")}}">Read more <i class="ml-1 button-icon far fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <!-- Post info End -->
                        </div>
