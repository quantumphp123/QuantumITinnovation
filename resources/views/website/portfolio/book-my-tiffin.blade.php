    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-8">
                 <h4 class="section-title text-center">Book My Tiffin</h4>
                <hr>
                <div class="container">
                    <!--<div class="row">-->
                    <!--    <div class="col-lg-6">-->
                    <!--        <img src="{{asset('assets/img/portfolio-images/portfolio/image4-1-298x497-iphone.png')}}" class="img-fluid">-->
                    <!--    </div>-->
                    <!--    <div class="col-lg-6">-->
                    <!--         <img src="{{asset('assets/img/portfolio-images/portfolio/image4-1-298x497.png')}}" class="img-fluid">-->
                    <!--    </div>-->
                    <!--</div>-->
                                            <img class="img-fluid" src="assets/images/projects/Website Images.jpg">
                </div>
            </div>
