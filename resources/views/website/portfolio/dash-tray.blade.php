    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-8">
                 <h4 class="section-title text-center" style="cursor:pointer;"><a href="https://firstclasstable.com/" target="_blank" class="text-decoration-none">Dash Tray</a></h4>
                <hr>
                <div class="container">
                    <img src="assets/images/projects/Dash-Tray.jpg" width="100%" >
                </div>
            </div>
