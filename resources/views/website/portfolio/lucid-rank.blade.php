    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-8">
                 <h4 class="section-title text-center" style="cursor:pointer;"><a href="https://www.lucidrank.com/" target="_blank" class="text-decoration-none">Lucid Rank</a></h4>
                <hr>
                <div class="container">
                    <img src="assets/images/projects/Lucid-Rank.jpg" width="100%" >
                </div>
            </div>
