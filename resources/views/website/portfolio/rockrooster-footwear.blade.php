    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-8">
                <h4 class="section-title text-center" style="cursor:pointer;"><a href="https://rockroosterfootwear.com/" target="_blank" class="text-decoration-none">Rockrooster Footwear</a></h4>
                <hr>
                <div class="container">
                    <img src="assets/images/projects/Rockrooster-Footwear.jpg" width="100%" >
                </div>
            </div>
