                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10">
                                ...
                                <p class="clr-wht" style="text-align: left !important;">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p class="clr-wht" style="text-align: left !important;">IoT provides analytic solutions to an organization which is verticalized and innovative and helps the decision-makers of an enterprise in preparing an insight for their business. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p class="clr-wht" style="text-align: left !important;">IoT helps the business to protect themselves from all kinds of security issues, especially in terms of privacy by providing them with safety-net services to perform transaction and connections across the ecosystem. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 mt-3">
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p class="clr-wht" style="text-align: left !important;">IoT provides engineering services to the business in terms of hardware, software, and cloud to enable the companies to achieve a competitive edge. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 mt-3">
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p class="clr-wht" style="text-align: left !important;">The automated management provided by IoT enables the companies to easily control compliance across various standards. </p>
                            </div>
                        </div>
                    </div>
                </div>
